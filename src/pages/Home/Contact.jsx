...
export const Contact = () => {
  return (
    ...
    >
      <span className="text-[#7c3aed] font-medium text-[15px] mt-8">
        Let's Talk
      </span>
      <h2
        className="text-[50px] text-gray-800 mb-4 "
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <form className="md:col-span-1 flex flex-col gap-4">
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1">
              ...
              <input
                ...
                className=" text-[14px] w-full rounded-xl border border-gray-200 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] bg-white"
              />
            </div>
            <div className="flex-1">
              <label className="block text-sm font-semibold mb-1">
          ...
          <div>
            ...
            <textarea
              ...
              className="text-[14px] w-full rounded-xl border border-gray-200 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#7c3aed] bg-white resize-none"
            />
          </div>
          <button
            type="submit"
            className="w-full bg-[#7c3aed] hover:bg-[#6d28d9] text-white font-semibold text-[16px] py-3 rounded-xl flex items-center justify-center gap-2 text-lg transition-all mt-2"
          >
            Send Message{" "}
            <span className="ml-1">
              <svg
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-[#f8f8fa] hover:bg-[#ede9fe] rounded-xl p-5 flex items-center gap-4 group cursor-pointer transition-colors">
            <span className="bg-[#ede9fe] text-[#7c3aed] rounded-lg p-3 text-2xl transition-colors duration-200 group-hover:bg-[#7c3aed] group-hover:text-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
